...
(function () {
  ...
  function Stepper(config) {
    ...
    // Mobile-Fix: Sichtbarkeits-Schwelle je Instanz konfigurierbar (Default 0.5, unveraendert fuer alle bestehenden Instanzen).
  ...
  (function () {
    ...
    var stepper = new Stepper({
      ...
      interval: 1500,
      autoplay: true,
      // Mobile-Fix: Hero-Szene ist im gestapelten Mobile-Layout beim Laden oft knapp unter 50% sichtbar, wodurch der Puls nie startete. Niedrigerer Schwellenwert behebt dies, Desktop bleibt unveraendert (dort ohnehin vollstaendig sichtbar).
      threshold: 0.2,
